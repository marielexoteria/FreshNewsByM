...
public class FreshNewsAdapter extends ArrayAdapter<FreshNews> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null) {
            ...
            newsHolder = (ViewHolder) listItemView.getTag();
        }
        ...
        Glide.with(getContext()).load(currentFreshNews.getThumbnail())
                .apply(
                        new RequestOptions()
                                .placeholder(R.drawable.loading_image_portrait)
                                .fallback(R.drawable.error_and_fallback_image_portrait)
                                .error(R.drawable.error_and_fallback_image_portrait)
                                .centerCrop())
                .into(newsHolder.newsPhoto);

        //Headline
        newsHolder.headline.setText(currentFreshNews.getHeadline());
